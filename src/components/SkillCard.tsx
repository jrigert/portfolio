  ...
  return (
    <div
      className={classNames(
        'flex flex-col justify-between rounded-md border-2 border-secondary px-4 py-2 font-semibold transition duration-500 hover:scale-110 hover:bg-secondary/10',
        className,
      )}
    >
